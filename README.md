...
Steps to run app:
- git clone this repo
- Use terminal to navigate to the folder containing the file "link_shortener.js"
...
- After visiting the new shortened URL, if you go back one step and now type into the browser: http://localhost:8080/visits/4gmu, (use your new shortened URL not the test one shown here (4gmu)) you will be able to view how many times that shortened URL has been hit.
